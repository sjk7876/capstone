...
\begin{figure}[!t]
    \centering
    \subfloat[Ball Detection on Serve]{%
      \includegraphics[width=0.8\columnwidth]{assets/sample_detections_serve.pdf}
    }
  
    \subfloat[Ball Detection on Landing]{%
      \includegraphics[width=0.8\columnwidth]{assets/sample_detections_landing.pdf}
    }

    \caption{Example YOLOv8 detections on 1080p frames. The ball is often small, blurred, or partially occluded.}
